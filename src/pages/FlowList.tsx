    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] font-sans selection:bg-violet-800">
            ...
            <header className="bg-white border-b border-slate-200 sticky top-0 z-10">
                <div className="w-full px-8 h-20 flex items-center justify-between">
                    ...
                    <button 
                        ...
                        className="flex items-center gap-2 bg-slate-900 hover:bg-slate-800 text-white px-5 py-2.5 rounded-xl font-semibold shadow-md transition-all hover:scale-105 active:scale-95 cursor-pointer"
                    >
                        <Plus size={18} />
                        Create New Flow
                    </button>
            ...
            <main className="w-full">
                ...
                {/* Table View */}
                <div className="bg-white border-y border-slate-200 overflow-visible shadow-sm w-full">
